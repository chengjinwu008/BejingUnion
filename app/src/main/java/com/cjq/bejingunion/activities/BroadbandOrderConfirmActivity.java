 ...
 */
public class BroadbandOrderConfirmActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.broadband_order_confirm);
        ...
        aq.id(R.id.broadband_order_confirm_back).clicked(this, "finish");
...
//                        System.out.println(object.toString());
                        if (200 == object.getInt("code")) {
                            ...
                            aq.id(R.id.broadband_order_confirm_count).text(String.valueOf(count));
                            aq.id(R.id.broadband_order_confirm_price).text(format.format(price));

                            Goods4OrderList goods4OrderList =  store4ShowList.get(1);
                            aq.id(R.id.broadband_order_confirm_image).image(goods4OrderList.getPortrait(), false, true);
...
//                            goods4OrderList.getDescription();
    ...
    public void submit(){
        try{
            ...
            params.put("pd_pay",aq.id(R.id.broadband_order_confirm_use_points).isChecked()?"1":"0");
