...
import com.cjq.bejingunion.activities.WriteEvaluationActivity;
...
public class EvaluationListAdapter extends BaseAdapter implements PinnedSectionListView.PinnedSectionListAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final Goods4IndexList g = goods4IndexListList.get(position);
        ...
        aq.id(R.id.evaluation_go_write_evaluation).clicked(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, WriteEvaluationActivity.class);
                intent.putExtra("id", g.getGoods_id());
