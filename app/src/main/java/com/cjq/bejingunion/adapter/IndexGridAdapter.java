...
public class IndexGridAdapter extends BaseAdapter {
    ...
    public IndexGridAdapter(Context context, List<Goods4IndexList> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(convertView ==null){
            convertView = LayoutInflater.from(context).inflate(R.layout.market_list_item_4_index,null,false);
        }
